        ...
        <div class="container-fluid">
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="card-title">Create Liability Or Owners Equity</h4>
                            <div class="basic-form">
                                <form action="{{url('create-new-liability')}}" method="post" >

                                    @csrf

                                    <div class="form-group">
                                        <span class="level_size">Ledger Name</span>
                                        <input type="text" autofocus  tabindex="1" name="client_name" class="input form-control" placeholder="Ledger Name" data-validation="required">
                                    </div>
                                    ...
                                    <div class="form-group margin_top_minus_10">
                                        <div class="form-check">
                                            <input class="input form-check-input" tabindex="8" type="checkbox" name="reconciliation" value="1">
                            ...
                            @else
                                <h4 class="card-title">Edit Liability Or Owners Equity Info</h4>
                                <div class="basic-form">
                                    <form action="{{url('edit-liability-info')}}" method="post" >

                                        @csrf

                                        <input type="hidden" name="id" value="{{$liability_info->id}}">
                                        <input type="hidden" name="ledger_id" value="{{$ledger_info->id}}">

                                        <div class="form-group">
                                            <span class="level_size">Ledger Name</span>
                                            <input type="text" tabindex="1" name="client_name" class="form-control" value="{{$liability_info->name}}" data-validation="required" placeholder="Ledger Name">
                                        </div>

                                        <div class="form-row margin_top_minus_10">
                                            <div class="form-group col-md-12">
                                                <span class="level_size">Catagory</span>
                                                <select id="inputState" tabindex="2" class="form-control" name="group_id" data-validation="required">
                                                    @foreach($sub_groups as $group)
                                                        @if($group->id == $liability_info->group_id)
                                        ...
                                        <div class="form-row margin_top_minus_10">
                                            <div class="form-group col-md-6">
                                                <span class="level_size">Contact No</span>
                                                <input type="text" tabindex="3" name="contact_no" value="{{$liability_info->contact_no}}" class="form-control" data-validation="required" placeholder="Contact No">
                                            </div>
                                            <div class="form-group col-md-6">
                                                <span class="level_size">Ledger Code</span>
                                                <input type="text" tabindex="4" name="code" class="form-control" value="{{$ledger_info->code}}" data-validation="required" placeholder="Ledger Code">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group margin_top_minus_10">
                                            <span class="level_size">Address</span>
                                            <input type="text" name="address" tabindex="5" class="form-control" value="{{$liability_info->address}}" placeholder="Address">
                                        </div>
                                        ...
                                        <div class="form-row margin_top_minus_10">
                                            ...
                                            <div class="form-group col-md-9">
                                                <span class="level_size">Opening Balance</span>
                                                <input type="text" tabindex="7" name="opening_balance" class="form-control" value="{{$ledger_info->op_balance}}" data-validation="required" placeholder="Opening Balance">
                                                <span class="level_size">Note : Assets / Expenses always have Dr balance and Liabilities / Incomes always have Cr balance.</span>
                                            </div>
                                        </div>
                                        ...
                                        <a href="{{url('create-liability')}}" tabindex="11" class="btn btn-dark">Create</a>
                                    </form>
                                </div>
            ...
            <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Liability Or Owners Equity Ledgers</h4>
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered zero-configuration">
                                        ...
                                        @foreach($liabilities as $liability)
                                            <?php
                                            $led = \App\Ledger::where('name', $liability->ledger_id)->first();
                                            $group = \App\Group::select('name')->where('id', $liability->group_id)->first();
                                            ?>
                                            <tr>
                                                <td>{{$liability->name}}</td>
                                                <td>{{$led->code}}</td>
                                                <td>{{$group->name}}</td>
                                                <td>{{$liability->address}}</td>
                                                <td><a href="{{url('edit-liability/'.$liability->id)}}" class="btn btn-primary">Edit</a> <a href="{{url('delete-liability/'.$liability->ledger_id)}}" class="btn btn-danger">Delete</a></td>
                                            </tr>
                                        @endforeach
