        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-green">
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        {!! Form::open(['url'=>'quotation_invoice', 'method'=>'post']) !!}
                        ...
                        <div class="form-group col-lg-6">
                            ...
                            <input class="form-control" name="entry_no" type="text" value="{{ $memo_no }}">
                        </div>
                        ...
                        <div class="form-group col-lg-6">
                            <label>Memo No:</label>
                            <input class="form-control" name="memo_no" type="text" value="" required>
                        </div>
                        ...
                        <table class="table order-list">
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php $r = $detail["rate"]; $q = str_replace(",","", $r); ?>
                        ...
                        <div class="col-md-2">
                            ...
                            <button type="button" onclick= "removerow()" class="btn btn-danger"><b>- Row</b></button>
                        </div>
                        <br><br>
                        <div class="col-md-12">
