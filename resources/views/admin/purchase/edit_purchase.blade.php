        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title"><b><span class="level_size_card_title">Edit Purchase Info</span></b></h4>
                            <div class="basic-form">
                                <form action="{{url('edit_purchase')}}" method="post" style="margin-top: -25px">

                                    <input type="hidden" name="_token" id="token" value="{{ csrf_token() }}">

                                    <input type="hidden" name="old_memo_id" value="{{$purchase_id}}">
                                    <input type="hidden" name="entry_id" value="{{$entry_id}}">
{{--                                    <input type="hidden" name="received_entry_id" value="{{$rc_id}}">--}}

                                    <input type="hidden" name="old_warehouse_id" value="{{$warehouse_id}}">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-6" style="margin-bottom: -5px">
                                                <div class="form-row">
                                                    <div class="form-group col-md-6" style="margin-top: -7px">
                                                        ...
                                                        <input class=" form-control" tabindex="1" type="date" value="{{$purchase_arr['entry_date']}}" name="entry_date">
                                                    </div>
                                                    <div class="form-group col-md-6" style="margin-top: -7px">
                                                        <span class="level_size">Entry No:</span>
                                                        <input class="form-control" tabindex="2" type="text" name="entry_no" value="{{ $purchase_arr['entry_no'] }}" readonly>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-row margin_top_minus_10">
                                                    ...
                                                    <div class="form-group col-md-6" style="margin-top: -7px">
                                                        ...
                                                        <div class="input-group">
                                                            <input class="form-control input " tabindex="3" list="suppliers" id="supplier_input" value="{{ $purchase_arr['supplier_name'] }}">
                                                            <datalist id="suppliers">
                                                                @foreach($supplier as $value)
                                                                    <option data-id="{{$value->id}}" value="{{ $value->supplier_name }}">
                                                                @endforeach
                                                            </datalist>
                                                            <input class="form-control input" type="hidden" id="supplier_id" value="{{$purchase_arr['supplier_id']}}" name="supplier_id">

                                                            <div class="input-group-btn" style="padding-bottom: 0px;">
                                                                <button href="#" data-toggle="modal" data-target="#login-modal" class="btn btn-skype display-3" value="{{ $purchase_arr['supplier_id'] }}" type="button" style="height: 33px"> <span class="icon-plus" ></span> </button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group col-md-6" style="margin-top: -7px">
                                                        ...
                                                        <input class="input form-control" autofocus  tabindex="4" placeholder="" value="{{ $purchase_arr['memo_no'] }}" type="text" name="ref_no" >
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-row margin_top_minus_10">
                                                    <div class="form-group col-md-6 margin_top_minus_10">
                                                        ...
                                                        <select class="input form-control js-example-basic-single" tabindex="5" name="warehouse_id" id="warehouse_id" data-validation="required">
                                                            ...
                                                            @foreach($warehouses as $value)
                                                                @if($value->id  == $purchase_arr['warehouse_id'])
                                                    ...
                                                    <div class="form-group col-md-6 margin_top_minus_10">
                                                        ...
                                                        <input class="input form-control" placeholder="{{$purchase_arr['remarks']}}" tabindex="6" type="text" name="remarks">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-group col-md-6" style="margin-bottom: -5px">
                                                ...
                                                <div class="row" style="margin-top: 5px; ">
                                                    ...
                                                    <div class="col-md-4">
                                                        <input type="text" name="discount_p" class="input form-control pdiscount" value="{{$purchase_arr['discount_p']}}" readonly>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <input type="text" name="discount" value="{{$purchase_arr['discount']}}" class="input form-control discount">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row" style="margin-top: 3px; ">
                                                    ...
                                                    <div class="col-md-4">
                                                        <input type="text" name="vat_p" class="input form-control pvat" value="{{$purchase_arr['vat_p']}}" readonly>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <input type="text" name="vat" class="input form-control vat" value="{{$purchase_arr['vat']}}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row" style="margin-top: 3px; ">
                                                    ...
                                                    <div class="col-md-4">
                                                        <input type="text" name="tax_p" class="input form-control ptax" value="{{$purchase_arr['tax_p']}}" readonly>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <input type="text" name="tax" class="input form-control tax" value="{{$purchase_arr['tax']}}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row" style="margin-top: 3px;">
                                                    ...
                                                    <div class="col-md-4">
                                                        <input type="text" name="column_total" class="input form-control column_total" value="{{$purchase_arr['total']}}" required readonly="" data-validation="required">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row" style="margin-top: 3px;">
                                                    ...
                                                    <div class="col-md-4">
                                                        <input type="text" name="balance" class="input form-control balance" value="{{$purchase_arr['due']}}"  data-validation="required" >
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
{{--                                    <h4 class="card-title" style="margin-top: 20px; margin-bottom: 10px">Products Info</h4>--}}
                                            ...
                                            <table class="table order-list">
                                                ...
                                                @foreach($entry_info_arr as $key=>$value )
                                                    <?php
                                                        ...
                                                        $cat_name_old = $value['cat_name'];
                                                        $available_qt = $value['available_qt'];
                                                        $product_id1 = $value['product_id'];
                                                        $p_name = $value['product_name'];
                                                        $qt_per_carton = $value['qt_per_carton'];
                                                        $carton = $value['carton'];
                                                        $pieces = $value['pieces'];
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width: 20%">
                                                        <input type="text" data-row="{{$i}}" tabindex="7" list="products" id="product_input" value="{{$p_name}}({{$cat_name_old}})" class="product_input_{{$i}} product_input input form-control">
                                                        ...
                                                        <input type="hidden" id="product_type_{{$i}}" name="product_type[]" value="{{$product_type_id}}" class="product_type_{{$i}} product_type">
                                                        <input type="hidden" id="product_code_name_{{$i}}" name="product_code[]" value="{{$product_id1}}" class="product_code_name_{{$i}} product_code_name">

                                                    </td>

                                                    <td style="width: 20%">
                                                        <div data-row="{{$i}}" class="rate_div_{{$i}} rate_div" >
                                                            <input type="text"  class="input form-control rate_{{$i}} rate" data-row="{{$i}}" value="{{$product_rate}}" name="product_rate[]"  data-validation="required">
                                                        </div>
                                                    </td>

                                                    <td style="width: 10%">
                                                        <input type="text" tabindex="8" data-row="{{$i}}" value="{{$carton}}" class="input form-control carton_{{$i}} carton"  name="carton[]" data-validation="number">
                                                        <input type="hidden" class="form-control qt_per_carton_{{$i}} qt_per_carton" value="{{$qt_per_carton}}" name="qt_per_carton[]">

                                                    </td>

                                                    <td style="width: 10%">
                                                        <input type="text" data-row="{{$i}}" tabindex="9" value="{{$pieces}}" class="input form-control piece_{{$i}} piece" name="piece[]" data-validation="number">
                                                    </td>
                                                    <td style="width: 15%">
                                                        <input type="text" data-row="{{$i}}" value="{{$quantity}}" class="input form-control quantity_{{$i}} quantity" name="quantity[]" readonly data-validation="required">
                                                    </td>
                                                    <td style="width: 20%">
                                                        <input type="text" name="total[]" data-row="1" value="{{$total}}" class="input form-control total_{{$i}} total" readonly data-validation="required">
                                                    </td>
                                                </tr>
                                                @endforeach
                                                </tbody>
...
@section('js')
    <script>
        ...
        function addrow()
        {
            ...
            cell2.innerHTML='<td><input type="text" data-row="'+i+'" list="products" id="product_input" class="product_input_'+i+' product_input input form-control">' +
                ...
                '</td>';
            cell3.innerHTML='<td><div data-row="'+i+'" class="input rate_div_'+i+' rate_div" name="rate[]"><input type="text" class="form-control" data-validation="number"> </div></td>';
            cell4.innerHTML='<input type="text" data-row="'+i+'" class="input form-control carton_'+i+' carton" value="0" name="carton[]" data-validation="number"> ' +
                '<input type="hidden" name="qt_per_carton[]" class="input form-control qt_per_carton_'+i+'" data-validation="number">';
            cell5.innerHTML='<input type="text" data-row="'+i+'" class="input form-control piece_'+i+' piece" value="0" name="piece[]" data-validation="number">';
            cell6.innerHTML='<input type="text" data-row="'+i+'" class="input form-control quantity_'+i+' quantity" name="quantity[]" readonly data-validation="number">';
            cell7.innerHTML='<input type="text" name="total[]" data-row="'+i+'" class="form-control total_'+i+' total" readonly data-validation="required" >';
        }
