        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title"> Edit Purchase Return</h4>
                            <div class="basic-form">
                                <form action="{{url('edit_purchase_return_info')}}" method="post" >

                                    <input type="hidden" name="_token" id="token" value="{{ csrf_token() }}">
                                    <input type="hidden" name="old_pr_id" value="{{$info_arr['old_id']}}">
                                    <input type="hidden" name="old_warehouse_id" value="{{$info_arr['warehouse_id']}}">
                                    ...
                                    <div style="border: 1px solid #CED4DA; padding: 10px; border-radius: 8px; " >
                                        <div class="form-row">
                                            <div class="form-group col-md-4">
                                                ...
                                                <input class=" form-control" tabindex="1" type="date" value="{{$info_arr['entry_date1']}}" name="entry_date">
                                            </div>
                                            <div class="form-group col-md-4">
                                                <span class="level_size">Memo No:</span>
                                                <input class="form-control" tabindex="2" name="memo_no" type="text" value="{{ $info_arr['memo_no'] }}" readonly>
                                            </div>
                                            <div class="form-group col-md-4">
                                                <span class="level_size">Supplier Memo No</span>
                                                <input class="input form-control" autofocus tabindex="3" placeholder="" value="{{$info_arr['ref_no']}}" type="text" name="ref_no" >
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-row margin_top_minus_10">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input class="form-control input " tabindex="4" list="suppliers" value="{{$info_arr['supplier_name']}}" id="supplier_input">
                                                <datalist id="suppliers">
                                                    @foreach($supplier as $value)
                                                        <option data-id="{{$value->id}}" value="{{ $value->supplier_name }}">
                                                    @endforeach
                                                </datalist>
                                                <input class="form-control input" type="hidden" id="supplier_id" value="{{$info_arr['supplier_id']}}" name="supplier_id">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <select class="input form-control js-example-basic-single warehouse_id" tabindex="5" name="warehouse_id" id="warehouse_id" data-validation="required">
                                                    ...
                                                    @foreach($warehouses as $value)
                                                        @if($info_arr['warehouse_id'] == $value->id)
                                        ...
                                        <div class="row margin_top_minus_10" >
                                            ...
                                            <div class="col-md-2">
                                                <input type="text" name="column_total" value="{{number_format($info_arr['total'], 2, '.', ',')}}" class="input form-control column_total" data-validation="required" readonly="" >                                            </div>
                                        </div>
                                    ...
                                    <div style="border: 1px solid #CED4DA; padding: 10px; border-radius: 8px; margin-top: 10px" >
                                        ...
                                        <div class="scroll">
                                            <table class="table order-list">
                                                ...
                                                @foreach($entry_info_arr as $key=>$value)
                                                    <?php
                                                        $old_product_type_id = $value['product_type_id'];
                                                        $old_cat_name = $value['cat_name'];
                                                        $old_available_qt = $value['available_qt'];
                                                        $old_product_id = $value['product_id'];
                                                        $old_product_name = $value['product_name'];
                                                        $old_qt_per_carton = $value['qt_per_carton'];
                                                        $old_carton = $value['carton'];
                                                        $old_pieces = $value['pieces'];
                                                        $old_quantity = $value['quantity'];
                                                        $old_product_rate = $value['product_rate'];
                                                        $old_total = $value['total'];
                                                ...
                                                <tr>
                                                    ...
                                                    <td  style="width: 25%">
                                                        <input type="text" data-row="{{$i}}" tabindex="7" value="{{$old_product_name}}({{$old_cat_name}})" list="products" id="product_input" class="product_input_{{$i}} product_input input form-control">
                                                        ...
                                                        <input type="hidden" id="product_type_{{$i}}" name="product_type[]" value="{{$old_product_type_id}}" class="product_type_{{$i}} product_type">
                                                        <input type="hidden" id="product_code_name_{{$i}}" name="product_code[]" value="{{$old_product_id}}" class="product_code_name_{{$i}} product_code_name">
                                                    ...
                                                    <td  style="width: 15%">
                                                        <div data-row="{{$i}}" class="rate_div_{{$i}} rate_div" >
                                                            <input type="text" data-row='{{$i}}'  class='input form-control rate_{{$i}} rate'  name="product_rate[]" value="{{$old_product_rate}}" data-validation="required">
                                                        </div>
                                                    </td>

                                                    <td  style="width: 10%">
                                                        <input type="text" data-row="{{$i}}" tabindex="8" value="{{$old_carton}}" class="input form-control carton_{{$i}} carton" name="carton[]" data-validation="required">
                                                        <input type="hidden" class="form-control qt_per_carton_{{$i}} qt_per_carton" value="{{$old_qt_per_carton}}" name="qt_per_carton[]" data-validation="number">
                                                        {{--<input type="text" class="form-control av_qt_1 av_qt" name="av_qt[]" data-validation="required">--}}

                                                    </td>

                                                    <td  style="width: 10%">
                                                        <input type="text" data-row="{{$i}}" tabindex="9" value="{{$old_pieces}}" class="input form-control piece_{{$i}} piece" name="piece[]" data-validation="number">
                                                    </td>
                                                    <td  style="width: 15%">
                                                        <input type="text" data-row="{{$i}}" value="{{$old_quantity}}" class="input form-control quantity_{{$i}} quantity" name="quantity[]" readonly data-validation="required">
                                                    </td>
                                                    <td  style="width: 20%">
                                                        <input type="text" name="total[]" value="{{$old_total}}" data-row="{{$i}}" class="input form-control total_{{$i}} total" readonly data-validation="required">
                                                    </td>
                                                </tr>
                                                @endforeach
                                                </tbody>
...
@section('js')
    <script type="text/javascript">
        ...
        function addrow()
        {
            ...
            cell3.innerHTML='<td><div data-row="'+i+'" class="input rate_div_'+i+' rate_div" name="rate[]"><input type="text" class="form-control"> </div></td>';
            ...
            cell6.innerHTML='<input type="text" data-row="'+i+'" class="input form-control quantity_'+i+' quantity" name="quantity[]" readonly>';
            cell7.innerHTML='<input type="text" name="total[]" data-row="'+i+'" class="form-control total_'+i+' total" readonly>';
        }
