        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Search Party Wise Summarized Sale Statement</h4>
                            <div class="basic-form">
                                <form  action="{{url('party_wise_summerized_sales')}}" method="post" target="_blank">


                                    @csrf
                                    <div class="form-group">
                                        <span class="level_size">Select Party</span>
                                        <select class="form-control js-example-basic-single" name="party_id" data-validation="required">
