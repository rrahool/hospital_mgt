...
//    $to_date_arr = explode('/', $date);
    ...
    <div style="text-align: center">
        ...
        <div style="margin-top: 5px; font-size: 20px; font-weight: bold">{{$heading}}</div>
        <div style="margin-top: 5px"> <span style="font-weight: bold">From: {{$from_d}} To: {{$to_d}}</span> </div><br>
        {{--        <div>Till {{$date}}</div>--}}
    </div>
            ...
            @foreach($arr_info as $key => $value)
                ...
                ?>
                        <tr>
                            ...
                            <td class="txt_align_right td-w-15">{{$rate}}</td>
