...
<div style="padding: 20px">
    ...
    <div style="text-align: center">
        ...
        <div style="margin-top: 5px; font-size: 20px; font-weight: bold">CLOSING STOCK WITH BUY & SALE RATE</div>
    ...
    <div >
        ...
        <table width="100%" cellspacing="0" cellpadding="0"  align="center" style="border-collapse: collapse;border:1px solid black ; margin-bottom: 20px; margin-top: 5px" >
            ...
            <tr>
                <td colspan="7"><b>CATEGORY: {{$cat_name}}</b></td>
            </tr>
            <?php
                $total_carton = 0;
                $total_pieces = 0;
