        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Sale/Purchase/Return Statement - Details</h4>
                            <div class="basic-form">
                                <form  action="{{url('sale_purchase_transfer_return')}}" method="post" target="_blank">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <div class="input-group">
                                                <input class="form-control input " tabindex="2" list="parties" id="party_input" placeholder="Party Name" data-validation="required">
                                                <div id="party_list">
