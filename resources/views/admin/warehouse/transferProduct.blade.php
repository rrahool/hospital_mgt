        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Transfer Entry</h4>
                            <div class="basic-form">
                                <form action="{{url('transfer_product')}}" method="post" >
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-4">
                                            ...
                                            <div class="input-group">
                                                <input type="text" tabindex="1" id="startpicker"  name="entry_date" required class="form-control mydatepicker" placeholder="mm/dd/yyyy"> <span class="input-group-append"><span class="input-group-text"><i class="mdi mdi-calendar-check"></i></span></span>
                                            </div>
                                        </div>

                                        <div class="form-group col-md-4">
                                            <span class="level_size">From</span>
                                            <select class="input form-control js-example-basic-single" tabindex="2" name="warehouse_from"  data-validation="required">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <select class="input form-control js-example-basic-single" tabindex="3" name="warehouse_to" data-validation="required">
                                                <option value="">Select Warehouse Name</option>
                                                @foreach($warehouses as $value)
                                                    <option value="{{ $value->id }}">{{ $value->warehouse_name }}</option>
                                                @endforeach
                                    ...
                                    <div class="form-row margin_top_minus_10">
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="hidden" class="qt_per_carton" tabindex="7" id="qt_per_carton" name="qt_per_carton">
                                            <input class="input form-control carton" id="carton" placeholder="Carton" type="text" name="carton" value="0" data-validation="number">
                                        </div>
                                        <div class="form-group col-md-4">
                                            <span class="level_size">Piece</span>
                                            <input class="input form-control pieces" tabindex="8" id="pieces" placeholder="piece" type="text" name="pieces" data-validation="number" data-validation-allowing="float">
                                        </div>
                                        <div class="form-group col-md-4">
                                            <span class="level_size">Total Quantity</span>
                                            <input class="input form-control quantity" tabindex="9" id="quantity" placeholder="Quantity" readonly type="text" name="quantity" data-validation="number">
                                        </div>
                                    </div>
                                    <button type="submit" class="btn btn-dark " tabindex="10" style="margin-top: 10px">Submit</button>
