                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="basic-form">
                                <form action="{{url('edit_memo_info_sale_return')}}" method="post" >

                                    <input type="hidden" name="_token" id="token" value="{{ csrf_token() }}">

                                    <input type="hidden" name="old_sr_id" value="{{$info_arr['old_id']}}">
                                    @foreach($entry_info_arr as $key=>$value)
                                        <input type="hidden" name="old_product_id[]" value="{{$value['product_id']}}">
                                        <input type="hidden" name="old_warehouse_id[]" value="{{$value['warehouse_id']}}">
                                        <input type="hidden" name="old_quantity[]" value="{{$value['quantity']}}">
                                        <br>
                                    @endforeach
                                    ...
                                    <div style="border: 1px solid #CED4DA; padding: 10px; border-radius: 8px; " >
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input class="input form-control" type="date" tabindex="1" value="{{ $info_arr['entry_date1'] }}" name="entry_date">
                                            </div>
                                        ...
                                        <div class="form-row margin_top_minus_10">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input class="form-control input " autofocus tabindex="3" list="clients" value="{{$info_arr['client_name']}}" id="client_input">
                                                <datalist id="clients">
                                                ...
                                                <input class="form-control input" type="hidden" id="client_id" value="{{$info_arr['client_id']}}" name="client_id">

                                            </div>

                                            <div class="form-group col-md-6">
                                                <span class="level_size">Ref No:</span>
                                                <input class="input form-control" tabindex="4" type="text" value="{{$info_arr['ref_no'] }}"  name="ref_no" >
                                            </div>
                                        </div>
                                        ...
                                        <div class="row margin_top_minus_10" style="margin-top: 0px;">
                                            ...
                                            <div class="col-md-2">
                                                <input type="text" name="column_total" value="{{$info_arr['total_payable']}}" class="input form-control column_total" data-validation="required" readonly="">
                                            </div>
                                        </div>
                                    ...
                                    <div style="border: 1px solid #CED4DA; padding: 10px; border-radius: 8px; margin-top: 10px" >
                                        ...
                                        <div class="scroll">
                                            <table class="table order-list">
                                                ...
                                                @foreach($entry_info_arr as $key=>$value)
                                                    <?php
                                                        $old_cat_id             = $value['product_type_id'];
                                                        $old_warehouse_id       = $value['warehouse_id'];
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width: 20%">
                                                        <select  data-row="{{$i}}" name="warehouse[]" tabindex="5" class="js-example-basic-single input form-control warehouse_{{$i}} warehouse" data-validation="required">
                                                            <option value="">Select Warehouse</option>
                                                            @foreach($warehouse_info as $value)
                                                                @if($old_warehouse_id == $value->id)
                                                    ...
                                                    <td style="width: 20%">
                                                        <input type="text" data-row="{{$i}}" tabindex="6" list="products" value="{{$old_product_name}}({{$old_cat_name}})" id="product_input" class="product_input_{{$i}} product_input input form-control">
                                                        ...
                                                        <input type="hidden" id="product_type_{{$i}}" name="product_type[]" value="{{$old_cat_id}}" class="product_type_{{$i}} product_type">
                                                        ...
                                                        <span class="available_qt_{{$i}}">Available Qt: {{$old_available_qt}}</span>
                                                    </td>


                                                    <td style="width: 15%">
                                                        <div data-row="{{$i}}" class="input rate_div_{{$i}} rate_div" >
                                                    ...
                                                    <td style="width: 5%">
                                                        <input type="text" data-row="{{$i}}" tabindex="7" value="{{$old_carton}}" class="input form-control carton_{{$i}} carton" name="carton[]" data-validation="number">
                                                        <input type="hidden" class="form-control qt_per_carton_{{$i}} qt_per_carton" value="{{$old_qt_per_carton}}" name="qt_per_carton[]">

                                                    </td>

                                                    <td style="width: 10%">
                                                        <input type="text" data-row="{{$i}}" tabindex="8" value="{{$old_pieces}}" class="input form-control piece_{{$i}} piece" name="piece[]"data-validation="number">
                                                    </td>
                                                    <td style="width: 10%">
                                                    ...
                                                    <td style="width: 15%">
                                                        <input type="text" name="total[]" data-row="{{$i}}" value="{{$old_total}}" class="input form-control total_{{$i}} total" readonly data-validation="required">
                                                    </td>
                                                </tr>
                                                @endforeach
                                                </tbody>
...
@section('js')
    <script>
        ...
        function addrow()
        {
            ...
            cell4.innerHTML='<td><div data-row="'+i+'" class="rate_div_'+i+' rate_div" name="rate[]"><input type="text" class="input form-control" data-validation="required"> </div></td>';
            ...
            cell7.innerHTML='<input type="text" data-row="'+i+'" class="input form-control quantity_'+i+' quantity" name="quantity[]" readonly data-validation="required">';
