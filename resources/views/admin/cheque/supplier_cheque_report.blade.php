...
@section('mainContend')
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header text-warning">Supplier Cheque</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>

        <div class="panel panel-info">
            <div class="panel-heading">Supplier Cheque</div>
            <div class="panel-body">
                <div class="row">
                    <table class="table table-bordered">
                        ...
                        <?php $i=1;  foreach($supplier_cheque as $each) { ?>
                        <tr>
                            <td><?=$i++;?></td>
                            <td><?=$each->supplier_name;?></td>
