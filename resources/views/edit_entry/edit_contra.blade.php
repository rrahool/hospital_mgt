        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Edit Contra Entry</h4>
                            <div class="basic-form">
                                <form action="{{url('edit-contra-entry')}}" method="post" >
                                        ...
                                        <div id="contra_div" >
                                            <div class="form-row  margin_top_minus_10" >
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <select class="form-control" name="contra_to" >
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <select class="form-control" name="contra_from">
                                                        @foreach($cash_ledgers as $c)
                                                            <?php
